...
class NoamScheduler(LRScheduler):
    ...
    def __init__(
        ...
        # Saving hyperparameters for the LR formula
        self.warmup_steps = warmup_steps
        self.d_model = d_model
        
        # Standard PyTorch init for schedulers
    ...
    def _get_lr_scale(self) -> float:
        ...
        # Apply the exact formula from the skeleton docstring
    ...
    def get_lr(self) -> list[float]:
        ...
        multiplier = self._get_lr_scale()
        
        # Scale the base learning rate for all parameter groups
